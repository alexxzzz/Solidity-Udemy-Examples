...
contract data_structures {
    ...
    Customer customer_1 = Customer(1, "alex", "alexrial02@gmail.com");
    ...
    function array_modification (uint256 _id, string memory name, string memory email) public {
        Customer memory random_customer = Customer (_id, name, email);
    ...
    function assignNumber (uint256 _number) public {
        address_uint[msg.sender] = _number; //clave entre corchetes y valor despues del igual        
    }

    // Asignar varios numeros a una direccion
    function asignList (string memory _name, uint256 _number) public {
